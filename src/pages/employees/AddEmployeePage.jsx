...
export default function AddEmployeePage() {
  const { departments, addEmployee } = useEms()
  ...
  const preview = useMemo(() => form.avatarUrl || 'https://i.pravatar.cc/150?img=15', [form.avatarUrl])
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
          Create a new employee record (dummy CRUD stored in localStorage).
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="grid gap-4 xl:grid-cols-3">
        ...
        <Card className="p-5">
          ...
          <div className="mt-5 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200 dark:bg-slate-950 dark:ring-white/10">
            ...
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
              Images are stored as Data URLs in localStorage for this demo.
            </p>
          </div>
        </Card>
      </form>
